...
function gtbrewing.press_active(pos, juice_name, percent, item_percent)
	local formspec = 
	"size[8,8.5]"..
	default.gui_bg..
	default.gui_bg_img..
...
function gtbrewing.get_press_formspec(pos, percent)
	...
	if meta:get_float("stored_juice") > 0 and meta:get_string("stored_juice_name") then
		juice_name = gtbrewing.get_juice_name(meta:get_string("stored_juice_name")).name
	end
	return gtbrewing.press_active(pos, juice_name, percent, item_percent)
end
 
gtbrewing.press_inactive_formspec =
	"size[8,8.5]"..
	default.gui_bg..
	default.gui_bg_img..
	default.gui_slots..
...
minetest.register_node("gtbrewing:fruit_press", {
	...
	paramtype2 = "facedir",
	drawtype = "nodebox",
	node_box = gtbrewing.fruit_press.off,
	selection_box = {
		type = "fixed",
	...
	tube = gtbrewing.pipeworks.fruit_press.tube,
	...
	on_destruct = function(pos)
		gtbrewing.remove_node_above(pos,{group = "fruitpress", groupvalue = 2})
	end,
	allow_metadata_inventory_put = function(pos, listname, index, stack, player)
		...
		if listname == "src" then
			if gtbrewing.get_juice(stack) ~= nil then
...
minetest.register_node("gtbrewing:fruit_press_on", {
	...
	is_ground_content = false,
	drawtype = "nodebox",
	node_box = gtbrewing.fruit_press.on,
	selection_box = {
		type = "fixed",
		fixed = {-0.5, -0.5, -0.5, 0.5, 0.5, 0.5},
	},
...
minetest.register_abm({
	...
	action = function(pos, node, active_object_count, active_object_count_wider)
		return gtbrewing.press_abm_action(pos, node)
	end,
})